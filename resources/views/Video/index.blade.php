...
@section('page_header')
        ...
        <h1 class="page-title">
            <i class="voyager-video"></i> Videos
                    ...
                    <a href="{{route('video.add')}}" class="btn btn-success btn-add-new">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="{{route('video.bulkDelete')}}" id="bulk_delete_form" method="POST">
                    ...
                    <div class="panel-body">
                            ...
                            <th class="actions text-right">Actions</th>
                                ...
                                <tbody>
                                 ...
                                 <tr><td>
                                  <input type="checkbox" name="row_id" id="checkbox_{{$video->id}}" value="{{$video->id}}">
                               </td>
                       ...
                       <td>
                      <img src="{{asset('upload'.$video->img_url)}}" style="width:100px;height: 70px">
                       </td>
                      ...
                      <td>
                       ...
                       <td class="no-sort no-click" id="bread-actions">
                           <a href="javascript:;" title="Delete" class="btn btn-sm btn-danger pull-right delete"data-id="{{$video->id}}" id="delete-{{$video->id}}">
            <i class="voyager-trash"></i> <span class="hidden-xs hidden-sm">Delete</span>
            <a href="{{route('video.edit',['id'=>$video->id])}}" title="Edit" class="btn btn-sm btn-primary pull-right edit">
            <i class="voyager-edit"></i> <span class="hidden-xs hidden-sm">Edit</span>
        </a>
            <a href="{{route('video.detail',['id'=>$video->id])}}" title="View" class="btn btn-sm btn-warning pull-right view">
