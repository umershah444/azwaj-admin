...
@section('content')
    ...
    <div class='col-xs-12 col-sm-6 col-md-4'><div class="panel widget center bgimage" style="margin-bottom:0;overflow:hidden;background-image:url('{{asset('images/widget-backgrounds/01.jpg')}}');">
    <div class="dimmer"></div>
    <div class="panel-content">
        <i class='voyager-group'></i>        <h4>{{$userCount}} Users</h4>
        <p>You have {{$userCount}} users in your database. Click on button below to view all users.</p>
        <a href="{{route('users.all')}}" class="btn btn-primary">View all users</a>
    </div>
</div>
</div><div class='col-xs-12 col-sm-6 col-md-4'><div class="panel widget center bgimage" style="margin-bottom:0;overflow:hidden;background-image:url('{{asset('images/widget-backgrounds/02.jpg')}}');">
    <div class="dimmer"></div>
    <div class="panel-content">
        <i class='voyager-people'></i>        <h4>{{$storyCount}} Success Stories</h4>
        <p>You have {{$storyCount}} stories in your database. Click on button below to view all stories.</p>
        <a href="{{route('story.all')}}" class="btn btn-primary">View all posts</a>
    </div>
</div>
</div><div class='col-xs-12 col-sm-6 col-md-4'><div class="panel widget center bgimage" style="margin-bottom:0;overflow:hidden;background-image:url('{{asset('images/widget-backgrounds/03.jpg')}}');">
    <div class="dimmer"></div>
    <div class="panel-content">
        <i class='voyager-file-text'></i>        <h4>1 Message</h4>
        <p>You have 1 new message. Click on button below to view all pages.</p>
        <a href="" class="btn btn-primary">View all message</a>
    </div>
</div>
</div>
</div>
