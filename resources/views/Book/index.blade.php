...
@section('page_header')
        ...
        <h1 class="page-title">
            <i class="voyager-book"></i> Books
                    ...
                    <a href="{{route('book.add')}}" class="btn btn-success btn-add-new">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="{{route('book.bulkDelete')}}" id="bulk_delete_form" method="POST">
...
@section('content')
        ...
        <div class="row">
                    ...
                    <div class="panel-body">
                            ...
                            <th class="actions text-right">Actions</th>
                                ...
                                <tbody>
                                 ...
                                 <tr><td>
                                  <input type="checkbox" name="row_id" id="checkbox_{{$book->id}}" value="{{$book->id}}">
                               </td>
                       ...
                       <td>
                      <img src="{{asset('upload'.$book->img_url)}}" style="width:100px;height: 70px">
                       </td>
            ...
            <a href="{{route('book.edit',['id'=>$book->id])}}" title="Edit" class="btn btn-sm btn-primary pull-right edit">
            <i class="voyager-edit"></i> <span class="hidden-xs hidden-sm">Edit</span>
        </a>
            <a href="{{route('book.detail',['id'=>$book->id])}}" title="View" class="btn btn-sm btn-warning pull-right view">
