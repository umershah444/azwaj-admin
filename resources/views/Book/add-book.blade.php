                    ...
                    <select class="form-control  select2 " name="locales[]"
                      ...
                      <div class="form-group">
                          ...
                          <div class="form-group">
                             ...
                             <div class="form-group">
                                <label for="password">Upload Pdf</label>
                                                               <input class="form-control" type="file" name="pdf_trans[]" id="pdf" value="">
