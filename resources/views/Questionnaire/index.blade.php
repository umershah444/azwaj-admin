...
@section('page_header')
        ...
        <h1 class="page-title">
            <i class="voyager-bar-chart"></i> Questionnaires
                    ...
                    <a href="{{route('questionnaire.add')}}" class="btn btn-success btn-add-new">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="{{route('questionnaire.bulkDelete')}}" id="bulk_delete_form" method="POST">
                    ...
                    <div class="panel-body">
                            ...
                            <th class="actions text-right">Actions</th>
                                ...
                                <tbody>
                                    ...
                                    @foreach($allQuestionnaires as $question)
                                 <tr><td>
                                  <input type="checkbox" name="row_id" id="checkbox_{{$question->id}}" value="{{$question->id}}">
                               </td>
                      ...
                      <td>
                       ...
                       <td class="no-sort no-click" id="bread-actions">
                           <a href="javascript:;" title="Delete" class="btn btn-sm btn-danger pull-right delete"data-id="{{$question->id}}" id="delete-{{$question->id}}">
            <i class="voyager-trash"></i> <span class="hidden-xs hidden-sm">Delete</span>
            <a href="{{route('questionnaire.edit',['id'=>$question->id])}}" title="Edit" class="btn btn-sm btn-primary pull-right edit">
            <i class="voyager-edit"></i> <span class="hidden-xs hidden-sm">Edit</span>
        </a>
            <a href="{{route('questionnaire.detail',['id'=>$question->id])}}" title="View" class="btn btn-sm btn-warning pull-right view">
