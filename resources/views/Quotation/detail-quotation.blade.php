 ...
 <div class="navbar-header">
            <button class="hamburger btn-link no-animation">
                <span class="hamburger-inner"></span>
                    ...
                    </li><li class="active"><a href="{{route('quotation.all')}}">Quotations</a>
                            </li></ol>                         
                    </div>
@stop
...
@section('page_header')
                   <h1 class="page-title">
        <i class="voyager-receipt"></i> Viewing Quotation &nbsp;

                    <a href="{{route('quotation.edit',['id'=>$quotation->id])}}" class="btn btn-info">
                <span class="glyphicon glyphicon-pencil"></span>&nbsp;
                Edit
            </a>
                            <a href="javascript:;" title="Delete" class="btn btn-danger delete" data-id="{{$quotation->id}}" id="delete-{{$quotation->id}}">
                <i class="voyager-trash"></i> <span class="hidden-xs hidden-sm">Delete</span>
            </a>
        
        <a href="{{route('quotation.all')}}" class="btn btn-warning">
