...
@section('page_header')
        ...
        <h1 class="page-title">
            <i class="voyager-receipt"></i> Quotations
                    ...
                    <a href="{{route('quotation.add')}}" class="btn btn-success btn-add-new">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="{{route('quotation.bulkDelete')}}" id="bulk_delete_form" method="POST">
                    ...
                    <div class="panel-body">
                            ...
                            <th class="actions text-right">Actions</th>
                                ...
                                <tbody>
                                 ...
                                 <tr><td>
                                  <input type="checkbox" name="row_id" id="checkbox_{{$quotation->id}}" value="{{$quotation->id}}">
                               </td>
                      ...
                      <td>
                       ...
                       <td class="no-sort no-click" id="bread-actions">
                           <a href="javascript:;" title="Delete" class="btn btn-sm btn-danger pull-right delete"data-id="{{$quotation->id}}" id="delete-{{$quotation->id}}">
            <i class="voyager-trash"></i> <span class="hidden-xs hidden-sm">Delete</span>
            <a href="{{route('quotation.edit',['id'=>$quotation->id])}}" title="Edit" class="btn btn-sm btn-primary pull-right edit">
            <i class="voyager-edit"></i> <span class="hidden-xs hidden-sm">Edit</span>
        </a>
            <a href="{{route('quotation.detail',['id'=>$quotation->id])}}" title="View" class="btn btn-sm btn-warning pull-right view">
...
@section('javascript')
       ...
       <script>
        ...
        $('td').on('click', '.delete', function (e) {
            $('#delete_form')[0].action = {!! json_encode(url("/Quotation/Delete/__id")) !!}.replace('__id', $(this).data('id'));
