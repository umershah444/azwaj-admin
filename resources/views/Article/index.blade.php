...
@section('page_header')
        ...
        <h1 class="page-title">
            <i class="voyager-news"></i> Articles
                    ...
                    <a href="{{route('article.add')}}" class="btn btn-success btn-add-new">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="{{route('article.bulkDelete')}}" id="bulk_delete_form" method="POST">
                    ...
                    <div class="panel-body">
                            ...
                            <th class="actions text-right">Actions</th>
                                ...
                                <tbody>
                                 ...
                                 <tr><td>
                                  <input type="checkbox" name="row_id" id="checkbox_{{$article->id}}" value="{{$article->id}}">
                               </td>
                       ...
                       <td>
                      <img src="{{asset('upload'.$article->img_url)}}" style="width:100px;height: 70px">
                       </td>
                      ...
                      <td>
                       ...
                       <td class="no-sort no-click" id="bread-actions">
                           <a href="javascript:;" title="Delete" class="btn btn-sm btn-danger pull-right delete"data-id="{{$article->id}}" id="delete-{{$article->id}}">
            <i class="voyager-trash"></i> <span class="hidden-xs hidden-sm">Delete</span>
            <a href="{{route('article.edit',['id'=>$article->id])}}" title="Edit" class="btn btn-sm btn-primary pull-right edit">
            <i class="voyager-edit"></i> <span class="hidden-xs hidden-sm">Edit</span>
        </a>
            <a href="{{route('article.detail',['id'=>$article->id])}}" title="View" class="btn btn-sm btn-warning pull-right view">
