...
@section('page_header')
        ...
        <h1 class="page-title">
            <i class="voyager-categories"></i> Categories
                    ...
                    <a href="{{route('category.add')}}" class="btn btn-success btn-add-new">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="{{route('category.bulkDelete')}}" id="bulk_delete_form" method="POST">
...
@section('content')
        ...
        <div class="row">
                    ...
                    <div class="panel-body">
                            ...
                            <th class="actions text-right">Actions</th>
                                ...
                                <tbody>
                                 ...
                                 <tr><td>
                                  <input type="checkbox" name="row_id" id="checkbox_{{$category->id}}" value="{{$category->id}}">
                               </td>
                       ...
                       <td>
                           {{$category->title}}
                            ...
                            @if($category->display_in_home == true)
            ...
            <a href="{{route('category.detail',['id'=>$category->id])}}" title="View" class="btn btn-sm btn-warning pull-right view">
